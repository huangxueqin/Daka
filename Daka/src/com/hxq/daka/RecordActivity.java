...
public class RecordActivity extends Activity implements
	...
	private boolean mTextMonthCellInfoShowing;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTextMonthCellInfo = (TextView)this.findViewById(R.id.id_tv_show_cell_info);
		mTextMonthCellInfo.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				mTextMonthCellInfo.setVisibility(View.GONE);
				mTextMonthCellInfoShowing = false;
			}
		});
	}
	...
	private class MonthCellClickListener implements MonthView.Listener {
		...
		public void handleClick(MonthCellDescriptor cell) {
			...
			String title = monthNameFormat.format(date);
			String missionInfo = mission == null ? "\nNo Activity" : "\n" + mission.getInfo();
			mTextMonthCellInfo.setText(title + missionInfo);
			mTextMonthCellInfo.setVisibility(View.VISIBLE);
			mTextMonthCellInfoShowing = true;
		}
